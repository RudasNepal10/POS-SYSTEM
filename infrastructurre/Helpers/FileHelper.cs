...
namespace SG.Domain.Helpers
{
    public class FileHelper : IFileHelper
    {
        ...
        {
            var allowedExtensions = new[] { ".jpeg", ".png", ".jpg",".svg",".pdf"};
        ...
        public bool isDocumentValid(string file_name)
        {
        ...
        public async Task<string> saveFileAndGetFileName(IFormFile file, string destination_folder, string file_prefix = "")
        {
        ...
        {
            var destinationPath = Path.Combine(hostingEnvironment.ContentRootPath, destination_folder);
